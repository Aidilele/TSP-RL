...
class ReplayBuffer:
    def __init__(self, buffer_size=2048, batch_size=256, ope_num=0, machine_num=0, gat_output_dim=0):
        ...
        self.h = np.zeros([buffer_size, (gat_output_dim*2+ope_dim)*2])
        self.c = np.zeros([buffer_size, (gat_output_dim*2+ope_dim)*2])
        ...
        self.hn = np.zeros([buffer_size, (gat_output_dim*2+ope_dim)*2])
        self.cn = np.zeros([buffer_size, (gat_output_dim*2+ope_dim)*2])
