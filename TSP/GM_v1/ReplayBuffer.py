...
class ReplayBuffer:
    ...
    def store(self, ope_fea, ope_adj, action_mask, h, c,
              action,
              reward,
              next_ope_fea, next_ope_adj, next_action_mask, hn, cn,
              done,
              ep_size):
        start = self.count
    ...
    def sample(self):
        ...
        return (ope_fea, ope_adj, action_mask,
                h, c,
                action,
                reward,
                next_ope_fea, next_ope_adj, next_action_mask,
                hn, cn,
                done)
